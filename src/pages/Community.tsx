...
const communityPosts = [
  {
    ...
    content:
      "I've been using the Chemistry Lab Assistant for 3 weeks now and it's transformed how I prepare experiments. Students are 40% more engaged and lab reports improved dramatically!",
  ...
  },
  {
    ...
    content:
      "The Math Differentiation Pack saved me 5 hours last week! I can now create 3 different versions of the same assignment in minutes. My struggling students finally feel confident.",
  ...
  },
  {
    ...
    content:
      "The Parent Communication Hub helped me turn around a difficult parent situation. The AI-suggested language was perfect - professional but warm. Highly recommend!",
  ...
  },
  {
    ...
    content:
      "We rolled out GoodClass tools to all our middle school teachers. 3 months later: 25% reduction in grading time, 15% increase in student engagement scores. The data speaks for itself!",
          ...
          <div className="lg:col-span-3">
              ...
              <div className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Help other teachers by sharing how AI tools have improved
                      your teaching
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <div className="space-y-6">
                  {communityPosts.map((post) => (
                    <Card
                      key={post.id}
                      className={post.isPinned ? "ring-2 ring-primary" : ""}
                    >
                      <CardHeader>
              ...
              <div className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Join ongoing conversations with fellow teachers
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
            ...
            {activeTab === "q-and-a" && (
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground">
                  Expert answers to your teaching questions
                </p>
              </div>
            )}
            ...
            {activeTab === "feedback" && (
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">
                  Feedback Hub Coming Soon
                </h3>
                <p className="text-muted-foreground">
                  Share your thoughts and help improve our tools
                </p>
              </div>
            )}
          </div>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-muted-foreground">
                            {contributor.posts} posts • {contributor.likes}{" "}
                            likes
                          </span>
                        </div>
                      </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Report improved teaching efficiency
                  </p>
                </div>
                <div className="text-center">
